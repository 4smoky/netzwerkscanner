...
def print_banner():
  ...
  print(f"{Color.YELLOW}For verbose output: sudo python3 netswerscanpy -v {Color.RESET}")
  print(f"{Color.YELLOW}To save results to CSV_json_html: sudo python3 your_script_name.py -o results.csv {Color.RESET}")
  print(f"{Color.YELLOW}Both options: sudo python3 your_script_name.py -v -o results.csv{Color.RESET}")
